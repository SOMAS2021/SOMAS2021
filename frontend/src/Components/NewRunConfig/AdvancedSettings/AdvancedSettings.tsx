    ...
    >
      ...
      <div className="modal-content">
        ...
        <FormGroup helperText="In Days..." label="Simulation Length" labelFor="text-input" >
            ...
            <FormGroup helperText="Agents can do one/two actions per 'Tick'" label="'Ticks' Per Floor" labelFor="text-input" >
                <NumericInput placeholder="10" onValueChange={(value) => configHandler(value, "TicksPerFloor")} />
            </FormGroup>
            <FormGroup helperText="Food on the platfrom at the beginnning of each day" label="Initial Food On The Platform" labelFor="text-input" >
                <NumericInput placeholder="100" onValueChange={(value) => configHandler(value, "FoodOnPlatform")} />
            </FormGroup>
            <FormGroup helperText="Number of Agents from Team 1 in the Tower" label="Agents of Team 1" labelFor="text-input" >
                <NumericInput placeholder="5" onValueChange={(value) => configHandler(value, "Team1Agents")} />
            </FormGroup>
            <FormGroup helperText="Number of Agents from Team 2 in the Tower" label="Agents of Team 2" labelFor="text-input" >
                <NumericInput placeholder="5" onValueChange={(value) => configHandler(value, "Team2Agents")} />
            </FormGroup>
            <FormGroup helperText="Number of Agents from Team 3 in the Tower" label="Agents of Team 3" labelFor="text-input" >
                <NumericInput placeholder="5" onValueChange={(value) => configHandler(value, "Team3Agents")} />
            </FormGroup>
            <FormGroup helperText="Number of Agents from Team 4 in the Tower" label="Agents of Team 4" labelFor="text-input" >
                <NumericInput placeholder="5" onValueChange={(value) => configHandler(value, "Team4Agents")} />
            </FormGroup>
            <FormGroup helperText="Number of Agents from Team 5 in the Tower" label="Agents of Team 5" labelFor="text-input" >
                <NumericInput placeholder="5" onValueChange={(value) => configHandler(value, "Team5Agents")} />
            </FormGroup>
            <FormGroup helperText="Number of Agents from Team 6 in the Tower" label="Agents of Team 6" labelFor="text-input" >
                <NumericInput placeholder="5" onValueChange={(value) => configHandler(value, "Team6Agents")} />
            </FormGroup>
            <FormGroup helperText="Number of Agents from Team 7 in the Tower" label="Agents of Team 7" labelFor="text-input" >
