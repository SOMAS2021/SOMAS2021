...
func NewHealthInfo(StrongLevel, HealthyLevel, WeakLevel, CriticalLevel, FoodReqStrong, FoodReqHealthy, FoodReqWeak, FoodReqCrtical, MaxDayCritical, FoodReqHToS, FoodReqWToH, FoodReqCToW int) *HealthInfo {
	return &HealthInfo{
		...
		FoodReqCritical: FoodReqCrtical,
